...
using mongo_match_plugin_impl_ptr = std::shared_ptr<class mongo_match_plugin_impl>;
 ...
 */
class mongo_match_plugin : public plugin<mongo_match_plugin> {
public:
   APPBASE_PLUGIN_REQUIRES((chain_plugin))

   mongo_match_plugin();
   virtual ~mongo_match_plugin();
...
private:
   mongo_match_plugin_impl_ptr my;
};
